...
public class LoginController {
    ...
    public String loginV3(@Validated @ModelAttribute LoginForm form, BindingResult bindingResult,
        ...
        // 로그인 성공 처리
        // 세션 관리자를 통해 세션 생성 및 회원 데이터 보관
        HttpSession session = request.getSession(true); // 세션이 있으면 기존 세션 반환, 세션 없으면 새로 생성
//        HttpSession session = request.getSession(false); // 세션이 있으면 기존 세션 반환, 세션 없으면 새로 안만듬 null 반환
        // 세션에 로그인 회원 정보 보관
